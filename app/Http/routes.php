...
Route::get('/Billing/{id}', 'MoneyController@makeForm');
Route::post('/Billing/{id}', 'MoneyController@chargeCustomer');

Route::get('/MakeBill', 'MoneyController@makeBill');
Route::post('/MakeBill', 'MoneyController@sendBill');