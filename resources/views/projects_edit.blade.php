...
<script type="text/javascript">
    var baseUrl = "{{ url('/') }}";
    var extendedUrl = "/Projects/" + document.getElementById('galleryname').innerHTML + "/upload";
...
<div class="grid">
    ...
    <group>
        ...
        <a href="/proj_add_home_page_gal/{!! $image->id !!}">Add To Home Page?</a>
        @elseif($image->home_page == 1)
        <a href="/proj_rem_home_page_gal/{!! $image->id !!}" class="red">Remove From Home Page</a>
        @endif
